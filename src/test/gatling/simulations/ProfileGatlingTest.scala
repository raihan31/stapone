...
class ProfileGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Profile entity")
        ...
        .repeat(2) {
            ...
            .post("/api/profiles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "address":"SAMPLE_TEXT", "contactNo":"SAMPLE_TEXT", "location":"SAMPLE_TEXT", "photo":null, "aboutMe":"SAMPLE_TEXT", "createdAt":"2020-01-01T00:00:00.000Z", "UpdatedAt":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
